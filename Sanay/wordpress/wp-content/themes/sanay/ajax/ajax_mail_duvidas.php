<?php
	...
	$nome  = utf8_decode($_POST['nome_duvidas']);
	$email  = utf8_decode($_POST['email_duvidas']);
	$tel = utf8_decode($_POST[ 'ddd_tel_duvidas']);
	$mensagem = utf8_decode($_POST['mensagem_duvidas']);
